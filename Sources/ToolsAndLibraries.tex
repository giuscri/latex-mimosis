...
graphically represents a simple neural network consisting of four input
neurons and four output neurons.
...
neural network can be used to classify 4 different classes of images.
