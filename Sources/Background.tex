...
gradient descent procedure; in Section \ref{sec:neural-networks} we'll
...
are adversarial examples and how they're generated.
...
we'll use it even if we will never touch the topic of linear regression
again.
